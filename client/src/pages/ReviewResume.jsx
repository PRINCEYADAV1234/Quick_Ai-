...
export default function ReviewResume() {
  ...
  return (
      ...
      <h1 className='text-xl font-semibold'>Review Resume</h1>
        ...
        <input onChange={(e)=>setInput(e.target.files[0])} type="file" accept=".pdf" className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300 ' placeholder=' Upload Your Resume PDF' required />

        <p className='mt-2 text-gray-500 text-sm font-light'>
           Supports only Pdf formats
        </p>
