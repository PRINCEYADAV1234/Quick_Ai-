...
<footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
            <a href="/">
                <img src={assets.logo} alt="img not show" />
            </a>
            <p className="text-sm/7 mt-6">QuickAI offers a suite of intelligent tools that streamline content creation, automate workflows, and enhance productivity using advanced machine learning.</p>
        </div>
